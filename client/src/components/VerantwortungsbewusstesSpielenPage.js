...
function VerantwortungsbewusstesSpielenPage() {
      ...
      <div className="container">
        <div className="page-content">
          ...
          <section className="content-section">
            <h2>Fazit</h2>
            <p>
              Verantwortungsbewusstes Spielen ist der Schlüssel zu einem positiven Spielerlebnis.
              Setzen Sie sich Grenzen, erkennen Sie Warnsignale früh und scheuen Sie sich nicht,
              Hilfe zu suchen, wenn Sie sie brauchen. Glücksspiel soll Unterhaltung sein – nichts mehr.
            </p>
          </section>
        </div>
      </div>
...
export default VerantwortungsbewusstesSpielenPage;
