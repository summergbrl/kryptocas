  ...
  return (
    <div className="App">
      ...
      <Routes>
        ...
        {/* New Components */}
        <Route path="/tests/mbit-casino" element={<ImportedTestsMbitPage />} />
        <Route path="/tests/arcanebet" element={<ImportedTestsArcanebetPage />} />
        <Route path="/tests/joo-casino" element={<ImportedTestsJooPage />} />
        ...
        <Route path="/tests/billionairespin-casino" element={<ImportedTestsBillionairespinPage />} />
